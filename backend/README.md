...
## Project Structure
    ...
    ├── testappmobile_dev_26001  # Django project configurations
...
1. Clone this repo and `cd testappmobile_dev_26001`
...
2. Clone this repo and `cd testappmobile_dev_26001`
